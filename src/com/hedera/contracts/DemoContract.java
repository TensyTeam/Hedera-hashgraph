...
public final class DemoContract {
	...
	public static void main(String... arguments) throws Exception {
		...
		account = AccountCreate.create(account, newAccountKey, 100000l); // 550000000000l
		...
		if (account != null) {
			...
			String filePath = System.getProperty("user.dir") + "/hedera.bin";
			System.out.println("Current dir: " + filePath);

			// get file contents
			InputStream is = DemoContract.class.getResourceAsStream(filePath);
